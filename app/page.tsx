...
export default function Portfolio() {
  ...
  return (
    <div className="bg-neutral-950 text-zinc-100 min-h-screen font-sans">
      <div className="z-999 fixed inset-0 -z-10 bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,0.03),transparent_60%),radial-gradient(circle_at_80%_80%,rgba(255,255,255,0.02),transparent_70%)] animate-[fogMove_20s_ease-in-out_infinite_alternate]" />
      {/* Header */}
